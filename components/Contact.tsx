...
Terima kasih.`;
  ...
  return (
    <section id="contact" className="py-24 bg-white dark:bg-navy transition-colors duration-300">
      <div className="container mx-auto px-6 text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-gold mb-4">
          Siap Mewujudkan Visi Anda?
        </h2>
        <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-10 transition-colors duration-300">
