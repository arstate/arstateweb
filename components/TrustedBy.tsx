      ...
      >
        ...
        <div className="flex animate-scroll group-hover:[animation-play-state:paused]">
          {[...clientLogos, ...clientLogos].map((logo, index) => (
            <div
              key={index}
              className="flex-shrink-0 w-36 h-36 mx-4 my-10 flex items-center justify-center bg-gray-200 dark:bg-white-100 p-4 rounded-2xl border-2 border-gray-300 dark:border-sky-300 transition-all duration-300 ease-in-out dark:hover:border-gold hover:shadow-xl hover:shadow-gold/30 hover:-translate-y-2"
