...
const Services: React.FC = () => {
  return (
    <section id="layanan" className="py-20 bg-navy/50">
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => (
            <div 
              key={index}
              className="bg-navy-card rounded-2xl p-8 border border-blue-500 flex flex-col items-center text-center transition-all duration-300 hover:border-gold hover:-translate-y-2 hover:shadow-xl hover:shadow-gold/20"
            >
